...
*** DONE 1.1 Hello, World
    ...
    #+caption: helloworld
    #+include: "ch1/helloworld.go" src go
*** DONE 1.2 Command-Line Arguments
    CLOSED: [2019-11-08 Fri 00:33]
    #+caption: echo1
    #+include: "ch1/echo1.go" src go
    ...
    #+caption: echo3
    #+include: "ch1/echo3.go" src go

    - Exercise 1.1
      #+caption: Modify the echo program to also print os.Args[0]
      #+include: "ch1/ex1.1.go" src go
    - Exercise 1.2
      #+caption: Modify the echo program to print the index and value of each of its arguments, one per line.
      #+include: "ch1/ex1.2.go" src go
    - Exercise 1.3
      #+begin_src sh
